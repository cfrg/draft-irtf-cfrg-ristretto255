...
tweaks such as multiplying by the cofactor in an appropriate place.
...
referred to in [@?RFC7748] as "curve25519".
...
* `(FALSE, +sqrt(-u/v))` if u and v are nonzero and u/v is
  non-square in the field (so `-(u/v)` is square in the field),
